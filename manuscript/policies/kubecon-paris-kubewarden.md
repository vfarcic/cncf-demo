...
yq --inplace ".policies.kind = \"admissionpolicy\"" settings.yaml

cp argocd/cncf-demo-$TEMPLATES.yaml apps/cncf-demo.yaml
...
kubectl --namespace production describe admissionpolicy \
    deploymentproduction

# Kubewarden does not show violations, but it does enforce them.
