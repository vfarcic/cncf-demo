...
import (
	_init_ "example.com/cdk8s/imports/certmanagerio/jsii"
	_jsii_ "github.com/aws/jsii-runtime-go/runtime"

	"example.com/cdk8s/imports/certmanagerio/internal"
...
func (j *jsiiProxy_Certificate) ApiGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiGroup",
...
func (j *jsiiProxy_Certificate) ApiVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersion",
...
func (j *jsiiProxy_Certificate) Chart() cdk8s.Chart {
...
func (j *jsiiProxy_Certificate) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_Certificate) Metadata() cdk8s.ApiObjectMetadataDefinition {
...
func Certificate_Manifest(props *CertificateProps) interface{} {
	_init_.Initialize()

	if err := validateCertificate_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func Certificate_Of(c constructs.IConstruct) cdk8s.ApiObject {
	_init_.Initialize()

	if err := validateCertificate_OfParameters(c); err != nil {
		panic(err)
	}
...
func Certificate_GVK() *cdk8s.GroupVersionKind {
	_init_.Initialize()
...
func (c *jsiiProxy_Certificate) AddDependency(dependencies ...constructs.IConstruct) {
	args := []interface{}{}
...
func (c *jsiiProxy_Certificate) AddJsonPatch(ops ...cdk8s.JsonPatch) {
	args := []interface{}{}
	for _, a := range ops {
		args = append(args, a)
	}
...
func (c *jsiiProxy_Certificate) ToJson() interface{} {
	var returns interface{}
