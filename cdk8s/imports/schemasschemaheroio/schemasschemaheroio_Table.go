...
import (
	_init_ "example.com/cdk8s/imports/schemasschemaheroio/jsii"
	_jsii_ "github.com/aws/jsii-runtime-go/runtime"

	"example.com/cdk8s/imports/schemasschemaheroio/internal"
...
func Table_Manifest(props *TableProps) interface{} {
	...
	if err := validateTable_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func Table_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateTable_OfParameters(c); err != nil {
		panic(err)
	}
